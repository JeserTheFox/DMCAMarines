...
/obj/vehicle/multitile/root/cm_armored
	...
	var/turret_icon = 'icons/obj/vehicles/tank_NS.dmi'
	var/turret_current = null
	var/camoflage_icon = 'icons/obj/vehicles/tank_NS_camo.dmi'
	var/camoflage_current = null
...
/*new icon system stuff
var/turret_icon = 'icons/obj/vehicles/tank_NS.dmi'
var/turret_current = "viper"
var/camoflage_icon = 'icons/obj/vehicles/tank_NS_camo.dmi'
var/camoflage_current = "jungle"*/
	...
	if(dir in list(NORTH, SOUTH))
		...
		camoflage_icon = 'icons/obj/vehicles/tank_NS_camo.dmi'

		visible_message("<span class='debuginfo'>Base sprite established.</span>")

	else if(dir in list(EAST, WEST))
		pixel_x = -48
		pixel_y = -32
		icon = 'icons/obj/vehicles/tank_EW.dmi'
		camoflage_icon = 'icons/obj/vehicles/tank_EW_camo.dmi'

		visible_message("<span class='debuginfo'>Base sprite established.</span>")

	if(camoflage_current)
		visible_message("<span class='debuginfo'>Camo confirmed.</span>")
		var/image/I = image(camoflage_icon, icon_state = "base_[camoflage_current]")
		overlays += I
		visible_message("<span class='debuginfo'>Camo added.</span>")

	if(turret_current)
		visible_message("<span class='debuginfo'>Turret confirmed.</span>")
		if(turret_dir in list(NORTH, SOUTH))
			turret_icon = 'icons/obj/vehicles/tank_NS.dmi'
			camoflage_icon = 'icons/obj/vehicles/tank_NS_camo.dmi'

		else if(turret_dir in list(EAST, WEST))
			turret_icon = 'icons/obj/vehicles/tank_EW.dmi'
			camoflage_icon = 'icons/obj/vehicles/tank_EW_camo.dmi'

		visible_message("<span class='debuginfo'>turret icon set.</span>")

		var/image/I = image(turret_icon, icon_state = "turret_[turret_current]", dir = turret_dir)
		overlays += I
		visible_message("<span class='debuginfo'>Turret added.</span>")
		if(camoflage_current)
			var/image/H = image(camoflage_icon, icon_state = "[turret_current]_[camoflage_current]", dir = turret_dir)
			overlays += H
			visible_message("<span class='debuginfo'>Turret camo added</span>")
