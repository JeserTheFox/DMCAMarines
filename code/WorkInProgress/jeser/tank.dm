...
/obj/vehicle/multitile/root/cm_armored/tank/verb/toggle_turret_stabilizer()
	set category = "Vehicle"
	set name = "Toggle Turret Stabilizer"
	set src = usr.loc

	if(usr != gunner)
		return

	turret_stabilizer = !turret_stabilizer
	to_chat(usr, "<span class='notice'>You toggle turret stabilizer [turret_stabilizer ? "<b>on</b>" : "<b>off</b>"].</span>")
